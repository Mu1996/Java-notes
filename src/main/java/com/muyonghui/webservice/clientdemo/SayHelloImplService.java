 ...
 * 
 */
@WebServiceClient(name = "SayHelloImplService", targetNamespace = "http://webservice.muyonghui.com/", wsdlLocation = "http://localhost:8080/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOIMPLSERVICE_QNAME = new QName("http://webservice.muyonghui.com/", "SayHelloImplService");
    ...
    public SayHelloImpl getSayHelloImplPort() {
        return super.getPort(new QName("http://webservice.muyonghui.com/", "SayHelloImplPort"), SayHelloImpl.class);
    }
    ...
    public SayHelloImpl getSayHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.muyonghui.com/", "SayHelloImplPort"), SayHelloImpl.class, features);
    }
